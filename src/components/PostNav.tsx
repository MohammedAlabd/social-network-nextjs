    ...
    <div className="navbar sticky top-0 z-10 h-10 bg-base-100">
      <div className="flex-1">
        <button type="button" className="mr-4 h-10 w-10">
          <Image src="/media/icons/collapse.svg" alt="collapse" width={34} height={34} />
        </button>
        ...
        <button type="button" className="btn-sm ml-2 flex items-center text-xl normal-case">
          <Image src={section.SectionPhoto} alt={section.SectionName} width={30} height={20} className="mr-2" />
          {section.SectionName}
        </button>
      </div>
      <div className="flex-none">
        ...
        <div className="dropdown">
          <div className="btn-ghost btn-circle btn ml-2 mr-2">
            <Image src="/media/icons/more.svg" alt="collapse" width={15} height={15} />
          </div>
