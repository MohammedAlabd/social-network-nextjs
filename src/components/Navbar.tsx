...
const Navbar = function (_Props: InferGetStaticPropsType<typeof getStaticProps>) {
  ...
  const bell = require('../../public/media/icons/bell.svg') as any;
  return (
      ...
      <div className="flex-none">
        <div className="bell dropdown-end dropdown">
          ...
          <div tabIndex={0} className="card dropdown-content card-compact z-[1] mt-3 w-52 bg-base-100 shadow">
            <div className="card-body">
              <span className="text-m border-b p-2 font-normal">User {t('navbar.liked your post')}</span>
              <button className="text-info">{t('navbar.See more')}</button>
            </div>
          </div>
        </div>
        <div className="dropdown-end dropdown">
          ...
          <ul tabIndex={0} className="dropdown-content menu rounded-box menu-sm z-[1] mt-3 w-52 bg-base-100 p-2 shadow">
            <li>
              <a className="justify-between">{t('navbar.Hello, ')} </a>
            </li>
            <li>
              <a className="justify-between">{t('navbar.Profile')}</a>
            </li>
            <li>
              <a>{t('navbar.Settings')}</a>
            </li>
            <li>
            <button className="block py-2 text-sm justify-between">
               {t("navbar.Sign out")}
            </button>
            </li>
          </ul>
